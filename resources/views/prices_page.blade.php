            ...
            <div class="content-box-prices-page">
                ...
                <div class="prices-types">
                    <div class="prices-types-child-one">
                        @if($product_plans['ims_studio_pro_1y']['discount'])

                        <div class="child-one-sale">
                            <img src="{{'storage/images/yellow-lent.png'}}" alt="">
                            <p>{{__('prices.saveRibbon')}} ${{price:$product_plans['ims_studio_pro_1y']['discount']}}!</p>
                        </div>
                        @endif
                        <div class="child-one-content">
                            ...
                            <a href="https://store.payproglobal.com/checkout?products[1][id]={{$product_plans['ims_studio_pro_1y'].payproglobal_plan_id}}&currency=USD" target="_blank" class="buy-btn first-btn" >{{__('prices.buyButton')}}</a>
                        </div>
                    </div>
                    <div class="prices-types-child-two">
                        <div class="prices-types-child-two-content">
                            ...
                            <a href="https://store.payproglobal.com/checkout?products[1][id]={{$product_plans['ims_studio_pro_3m'].payproglobal_plan_id}}&currency=USD" target="_blank" class="buy-btn second-btn" >{{__('prices.buyButton')}}</a>
                        </div>
                    </div>
                </div>
            </div>
